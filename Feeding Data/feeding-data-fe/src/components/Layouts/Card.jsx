  ...
  return (
    <>
      <div
        ...
        className="rounded-lg p-4 bg-white shadow-md space-y-4 cursor-pointer transition ease-in duration-200 hover:scale-105 flex flex-col"
      >
